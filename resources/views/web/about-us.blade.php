                ...
                <div class="row aboutWrapper">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="aboutContentWrapper">
                            <span class="commonTag"> {{isset($about->tag) ? $about->tag : "Sobre Nosotros"}}</span>
            ...
            <div class="container">
                <div class="row whoWeAreContentWrapper">
                    ...
                    <div class="col-lg-6 whoweAreImgDiv">
                        <div class="">
                            <img src="{{isset($whoweare->image) ? $whoweare->image : url('assets/images/who-we-are-img.png')}}"
                                alt="">
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="swiperDataWrapper">
                                            <div class="card">
                                                ...
                                                <div class="teacherDetails">
                                                    <span
                                                        class="name">{{$teacher->user->first_name . '  ' . $teacher->user->last_name}}</span>
