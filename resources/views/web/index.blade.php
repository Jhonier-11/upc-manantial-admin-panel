                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="aboutContentWrapper">
                            ...
                            <button class="commonBtn">
                                <a href="{{ route('about.us') }}">{{ __('read_more') }}</a> <i
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="flex_column_center">
                                        <span class="commonTag">
                                            {{ isset($program->tag) ? $program->tag : 'Programas de Educacion' }}
                                        </span>
                                        <span class="commonTitle">
                                            {{ isset($program->heading) ? $program->heading : 'Programas educacionales para todas las etapas' }}
                                        </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="programsCardWrapper">
                                        <div class="row">
                                            ...
                                            @endif
                                            <div class="sideImgs">
                                                <img src="{{ url('assets/images/notes.svg') }}" class="notesImg"
                                                    alt="notesImg">
                                                <img src="{{ url('assets/images/bulbImg.svg') }}" class="bulbImg"
                                                    alt="bulbImg">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="eventDescWrapper">
                                                ...
                                                <div class="eventDate">
                                                    ...
                                                    @else
                                                        @if ($item->end_date)
                                                            <span
                                                                class="month">{{ date('d M, Y', strtotime($item->start_date)) . '  To  ' . date('d M, Y', strtotime($item->end_date)) }}</span>
                                                        @else
                        ...
                        <div id="eventModal" class="modal">
                            <div class="modal-content modal-dialog-scrollable">
                                ...
                                <div class="event-modal-body">
                                    ...
                                    <img class="eventImage" style="display: none" id="eventImage" src=""
                                        alt="image" /><br><br><br>
                            ...
                            <div class="slider-content owl-carousel">
                                @if (isset($videos))
                                    @foreach ($videos as $index => $item)
                                        <div class="swiperDataWrapper">
                                            <div class="img_div">
                                                <img src="{{$item->embeded_url['thumbnailUrl'] }}"
                                                    data-embedUrl="{{$item->embeded_url['embedUrl'] }}" class="openVideo"
                                                    alt="Thumbnail">
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <div id="videoModal" class="modal">
                        <div class="modal-content">
                            <div class="iframe_div">
                                <iframe id="videoIframe" class="video_player" src="" frameborder="0"
                ...
                <div class="col-12">
                    <div class="row wrapper">
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card">
                                <span>
                                    <img src="{{ url('assets/images/androidApp.svg') }}" class="card-img-top" alt="...">
                                </span>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card">
                                <span>
                                    <img src="{{ url('assets/images/iosApp.svg') }}" class="card-img-top" alt="...">
                                </span>
                                <span class="appName">{{ __('student_parent_app') }}</span>
                                <span class="demoBtn"><a
                                        href="{{ isset($settings['ios_app_link']) ? $settings['ios_app_link'] : '' }}"
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card">
                                ...
                                <span class="demoBtn"><a
                                        href="{{ isset($settings['teacher_app_link']) ? $settings['teacher_app_link'] : '' }}"
                                        style="color: #ffffff !important">
                                        {{ __('android_demo') }}</a>
                                    <i class="fa-solid fa-arrow-right"></i>
                                </span>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="card">
                                ...
                                <span class="appName">{{ __('teacher_app') }}</span>
                                <span class="demoBtn"><a
                                        href="{{ isset($settings['teacher_ios_app_link']) ? $settings['teacher_ios_app_link'] : '' }}"
                                        style="color: #ffffff !important">
                                        {{ __('ios_demo') }}</a>
                                    <i class="fa-solid fa-arrow-right"></i>
                                </span>
